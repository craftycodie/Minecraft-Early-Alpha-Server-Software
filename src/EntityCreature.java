...
/*     */   
/*     */   public EntityCreature(World paramdp) {
/*  12 */     super(paramdp);
/*     */ 
/*     */ 
/*     */ 
...
/*  24 */       this.af = h();
/*  25 */       if (this.af != null) {
/*  26 */         this.a = this.worldObj.a(this, this.af, f);
/*     */       }
/*     */     }
...
/*  47 */       this.a = this.worldObj.a(this, this.af, f);
...
/*     */       
/*  69 */       if (bool) {
/*  70 */         this.a = this.worldObj.a(this, j, k, m, 10.0F);
/*     */       }
/*     */     } 
/*     */     
/*  74 */     int i = MathHelper.floor_double(this.boundingBox.b);
/*     */     
/*  76 */     boolean bool1 = handleWaterMovement();
/*  77 */     boolean bool2 = o();
...
/* 157 */     int j = MathHelper.floor_double(this.boundingBox.b);
