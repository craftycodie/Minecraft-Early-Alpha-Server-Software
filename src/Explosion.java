...
/*  83 */         d3 /= d4;
/*     */         
/*  85 */         double d5 = paramdp.a(as, db1.boundingBox);
/*  86 */         double d6 = (1.0D - d) * d5;
/*  87 */         db1.attackEntityFrom(paramdb, (int)((d6 * d6 + d6) / 2.0D * 8.0D * paramFloat + 1.0D));
/*     */         
/*  89 */         double d7 = d6;
/*  90 */         db1.motionX += d1 * d7;
/*  91 */         db1.motionY += d2 * d7;
/*  92 */         db1.motionZ += d3 * d7;
/*     */       } 
/*     */     } 
/*  95 */     paramFloat = f;
/*     */     
