...
/*    */   private int h;
            private int i;
/*    */   
/*    */   public ItemInWorldManager(World paramdp) {
/* 18 */     this.thisWorld = paramdp;
/*    */   }

/*    */   public void a(int paramInt1, int paramInt2, int paramInt3) {
/* 22 */     int i = this.thisWorld.getBlockId(paramInt1, paramInt2, paramInt3);
/* 23 */     if (i > 0 && this.d == 0.0F) Block.blocksList[i].b(this.thisWorld, paramInt1, paramInt2, paramInt3, this.thisPlayer);
/* 24 */     if (i > 0 && Block.blocksList[i].a(this.thisPlayer) >= 1.0F) {
...
/* 66 */     Block et = Block.blocksList[this.thisWorld.getBlockId(paramInt1, paramInt2, paramInt3)];
/* 67 */     int i = this.thisWorld.getBlockMetadata(paramInt1, paramInt2, paramInt3);
/* 68 */     boolean bool = this.thisWorld.setBlockWithNotify(paramInt1, paramInt2, paramInt3, 0);
/* 69 */     if (et != null && bool) {
/* 70 */       et.a(this.thisWorld, paramInt1, paramInt2, paramInt3, i);
/*    */     }
/* 72 */     return bool;
/*    */   }
/*    */   
/*    */   public boolean c(int paramInt1, int paramInt2, int paramInt3) {
/* 76 */     int i = this.thisWorld.getBlockId(paramInt1, paramInt2, paramInt3);
/* 77 */     int j = this.thisWorld.getBlockMetadata(paramInt1, paramInt2, paramInt3);
...
/*    */       } 
/*    */     } 
/* 88 */     if (bool && this.thisPlayer.b(Block.blocksList[i])) Block.blocksList[i].a_(this.thisWorld, paramInt1, paramInt2, paramInt3, j);
/* 89 */     return bool;
/*    */   }
/*    */ 
/*    */ 
