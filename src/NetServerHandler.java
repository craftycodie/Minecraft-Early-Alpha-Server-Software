                    ...
                    switch(this.playerEntity.inventory.getCurrentItem().c) {
                        ...
                        case 325:  // empty bucket
                            ...
                            if (blockId == Block.B.blockId || blockId == Block.D.blockId) {
                                ...
                                this.playerEntity.playerNetServerHandler.sendPacket(new Packet53BlockChange(i, j + 1, k, this.mcServer.worldserver));
                                break;
                            }
                            return;
                        ...
                        case 294:
                            ...
                            if (blockId == Block.u.blockId || blockId == Block.v.blockId) {
                                ...
                                this.playerEntity.playerNetServerHandler.sendPacket(new Packet53BlockChange(blockX, blockY - 1, blockZ, this.mcServer.worldserver));
                                return;
                            }
                            return;
                        case 295: // seeds
                            if (this.playerEntity.worldObj.getBlockId(blockX, blockY - 1, blockZ) == Block.aA.blockId) {
                                ...
                                this.playerEntity.playerNetServerHandler.sendPacket(new Packet53BlockChange(blockX, blockY, blockZ, this.mcServer.worldserver));
                                return;
                            }
                            return;
                        case 331: // redstone
