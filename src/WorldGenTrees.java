...
/*    */ {
    public boolean a(World world, Random random, int i, int j, int k)
    {
        ...
        if(j1 != Block.u.blockId && j1 != Block.v.blockId || j >= 128 - l - 1)
        {
            return false;
        }
        world.setBlock(i, j - 1, k, Block.v.blockId);
        for(int k1 = (j - 3) + l; k1 <= j + l; k1++)
        {
            ...
            for(int k3 = i - i3; k3 <= i + i3; k3++)
            {
                ...
                for(int i4 = k - i3; i4 <= k + i3; i4++)
                {
                    ...
                    {
                        world.setBlock(k3, k1, i4, Block.K.blockId);
                    }
                }
        ...
        for(int l1 = 0; l1 < l; l1++)
        {
            ...
            if(k2 == 0 || k2 == Block.K.blockId)
            {
                world.setBlock(i, j + l1, k, Block.J.blockId);
            }
        }
