...
/*     */   extends et
/*     */ {
/*     */   protected ag(int paramInt1, int paramInt2) {
/*  12 */     super(paramInt1, paramInt2, hz.n);
/*  13 */     a(true);
/*     */   }
/*     */   
...
/*  50 */     int i = paramdp.b(paramInt1, paramInt2, paramInt3);
/*     */     
/*  52 */     int j = i & 0x8;
/*  53 */     i &= 0x7;
/*     */     
...
/*  78 */       int i = paramdp.b(paramInt1, paramInt2, paramInt3) & 0x7;
...
/*     */       
/*  86 */       if (bool) {
/*  87 */         a_(paramdp, paramInt1, paramInt2, paramInt3, paramdp.b(paramInt1, paramInt2, paramInt3));
/*  88 */         paramdp.d(paramInt1, paramInt2, paramInt3, 0);
/*     */       } 
/*     */     } 
/*     */   }
/*     */   
...
/*  95 */       a_(paramdp, paramInt1, paramInt2, paramInt3, paramdp.b(paramInt1, paramInt2, paramInt3));
/*  96 */       paramdp.d(paramInt1, paramInt2, paramInt3, 0);
/*  97 */       return false;
/*     */     } 
/*  99 */     return true;
/*     */   }
...
/* 103 */     int i = paramhb.b(paramInt1, paramInt2, paramInt3);
/* 104 */     int j = i & 0x7;
...
/* 129 */     int i = paramdp.b(paramInt1, paramInt2, paramInt3);
/* 130 */     int j = i & 0x7;
/* 131 */     int k = 8 - (i & 0x8);
...
/*     */     
/* 139 */     paramdp.g(paramInt1, paramInt2, paramInt3, this.ba);
/* 140 */     if (j == 1) {
/* 141 */       paramdp.g(paramInt1 - 1, paramInt2, paramInt3, this.ba);
/* 142 */     } else if (j == 2) {
/* 143 */       paramdp.g(paramInt1 + 1, paramInt2, paramInt3, this.ba);
/* 144 */     } else if (j == 3) {
/* 145 */       paramdp.g(paramInt1, paramInt2, paramInt3 - 1, this.ba);
/* 146 */     } else if (j == 4) {
/* 147 */       paramdp.g(paramInt1, paramInt2, paramInt3 + 1, this.ba);
/*     */     } else {
/* 149 */       paramdp.g(paramInt1, paramInt2 - 1, paramInt3, this.ba);
/*     */     } 
/*     */     
/* 152 */     paramdp.h(paramInt1, paramInt2, paramInt3, this.ba);
/*     */     
/* 154 */     return true;
/*     */   }
/*     */   
/*     */   public void b(dp paramdp, int paramInt1, int paramInt2, int paramInt3) {
/* 158 */     int i = paramdp.b(paramInt1, paramInt2, paramInt3);
/* 159 */     if ((i & 0x8) > 0) {
/* 160 */       paramdp.g(paramInt1, paramInt2, paramInt3, this.ba);
/* 161 */       int j = i & 0x7;
/* 162 */       if (j == 1) {
/* 163 */         paramdp.g(paramInt1 - 1, paramInt2, paramInt3, this.ba);
/* 164 */       } else if (j == 2) {
/* 165 */         paramdp.g(paramInt1 + 1, paramInt2, paramInt3, this.ba);
/* 166 */       } else if (j == 3) {
/* 167 */         paramdp.g(paramInt1, paramInt2, paramInt3 - 1, this.ba);
/* 168 */       } else if (j == 4) {
/* 169 */         paramdp.g(paramInt1, paramInt2, paramInt3 + 1, this.ba);
/*     */       } else {
/* 171 */         paramdp.g(paramInt1, paramInt2 - 1, paramInt3, this.ba);
/*     */       } 
/*     */     } 
...
/* 178 */     return ((paramhb.b(paramInt1, paramInt2, paramInt3) & 0x8) > 0);
/*     */   }
/*     */   
/*     */   public boolean d(dp paramdp, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
/* 182 */     int i = paramdp.b(paramInt1, paramInt2, paramInt3);
...
/* 201 */     int i = paramdp.b(paramInt1, paramInt2, paramInt3);
/* 202 */     if ((i & 0x8) == 0) {
/*     */       return;
/*     */     }
/* 205 */     paramdp.b(paramInt1, paramInt2, paramInt3, i & 0x7);
/*     */     
/* 207 */     paramdp.g(paramInt1, paramInt2, paramInt3, this.ba);
/* 208 */     int j = i & 0x7;
/* 209 */     if (j == 1) {
/* 210 */       paramdp.g(paramInt1 - 1, paramInt2, paramInt3, this.ba);
/* 211 */     } else if (j == 2) {
/* 212 */       paramdp.g(paramInt1 + 1, paramInt2, paramInt3, this.ba);
/* 213 */     } else if (j == 3) {
/* 214 */       paramdp.g(paramInt1, paramInt2, paramInt3 - 1, this.ba);
/* 215 */     } else if (j == 4) {
/* 216 */       paramdp.g(paramInt1, paramInt2, paramInt3 + 1, this.ba);
/*     */     } else {
/* 218 */       paramdp.g(paramInt1, paramInt2 - 1, paramInt3, this.ba);
/*     */     } 
/*     */     
...
/* Location:              D:\Projects\Local\MinecraftBetaOfflineLauncher\Binaries\Test Server\a0.0.1.jar!\ag.class
