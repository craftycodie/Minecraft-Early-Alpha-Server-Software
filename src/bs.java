...
/* 26 */     this.n = (-MathHelper.a(f * 3.1415927F / 180.0F) * 0.02F);
/* 27 */     this.o = 0.20000000298023224D;
/* 28 */     this.p = (-MathHelper.b(f * 3.1415927F / 180.0F) * 0.02F);
/*    */     
/* 30 */     this.G = false;
/* 31 */     this.a = 80;
/*    */     
...
/* 61 */       b();
/*    */     } else {
/* 63 */       this.g.a("smoke", this.posX, this.posY + 0.5D, this.posZ, 0.0D, 0.0D, 0.0D);
/*    */     } 
/*    */   }
/*    */ 
/*    */   
/*    */   private void b() {
/* 69 */     float f = 4.0F;
/* 70 */     this.g.a((Entity)null, this.posX, this.posY, this.posZ, f);
/*    */   }
/*    */ 
/*    */ 
/*    */ 
