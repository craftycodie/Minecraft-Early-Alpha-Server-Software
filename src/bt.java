...
/*     */   
/*     */   private boolean a(dp paramdp, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean) {
...
/*     */   }
/*     */   
/*     */   protected bt(int paramInt1, int paramInt2, boolean paramBoolean) {
...
/*  58 */     if (paramdp.b(paramInt1, paramInt2, paramInt3) == 0) super.e(paramdp, paramInt1, paramInt2, paramInt3); 
/*  59 */     if (this.a) {
/*  60 */       paramdp.g(paramInt1, paramInt2 - 1, paramInt3, this.ba);
/*  61 */       paramdp.g(paramInt1, paramInt2 + 1, paramInt3, this.ba);
/*  62 */       paramdp.g(paramInt1 - 1, paramInt2, paramInt3, this.ba);
/*  63 */       paramdp.g(paramInt1 + 1, paramInt2, paramInt3, this.ba);
/*  64 */       paramdp.g(paramInt1, paramInt2, paramInt3 - 1, this.ba);
/*  65 */       paramdp.g(paramInt1, paramInt2, paramInt3 + 1, this.ba);
/*     */     } 
/*     */   }
/*     */   
/*     */   public void b(dp paramdp, int paramInt1, int paramInt2, int paramInt3) {
/*  70 */     if (this.a) {
/*  71 */       paramdp.g(paramInt1, paramInt2 - 1, paramInt3, this.ba);
/*  72 */       paramdp.g(paramInt1, paramInt2 + 1, paramInt3, this.ba);
/*  73 */       paramdp.g(paramInt1 - 1, paramInt2, paramInt3, this.ba);
/*  74 */       paramdp.g(paramInt1 + 1, paramInt2, paramInt3, this.ba);
/*  75 */       paramdp.g(paramInt1, paramInt2, paramInt3 - 1, this.ba);
/*  76 */       paramdp.g(paramInt1, paramInt2, paramInt3 + 1, this.ba);
/*     */     } 
/*     */   }
/*     */   
...
/*     */     
/*  83 */     int i = paramhb.b(paramInt1, paramInt2, paramInt3);
/*     */     
...
/*  95 */     int i = paramdp.b(paramInt1, paramInt2, paramInt3);
/*     */     
...
/* 112 */     if (this.a) {
/* 113 */       if (bool) {
/* 114 */         paramdp.b(paramInt1, paramInt2, paramInt3, et.aP.ba, paramdp.b(paramInt1, paramInt2, paramInt3));
/*     */         
...
/* 130 */       paramdp.b(paramInt1, paramInt2, paramInt3, et.aQ.ba, paramdp.b(paramInt1, paramInt2, paramInt3));
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/* 147 */     paramdp.h(paramInt1, paramInt2, paramInt3, this.ba);
/*     */   }
/*     */   
/*     */   public boolean d(dp paramdp, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
/* 151 */     if (paramInt4 == 0) {
/* 152 */       return b(paramdp, paramInt1, paramInt2, paramInt3, paramInt4);
/*     */     }
/* 154 */     return false;
/*     */   }
/*     */   
