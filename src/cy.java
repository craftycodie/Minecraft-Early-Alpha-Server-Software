...
/*     */   
/*     */   public static cy a(double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4, double paramDouble5, double paramDouble6) {
/*  10 */     return new cy(paramDouble1, paramDouble2, paramDouble3, paramDouble4, paramDouble5, paramDouble6);
/*     */   }
...
/*     */   }
/*     */   
/*     */   public static cy b(double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4, double paramDouble5, double paramDouble6) {
/*  18 */     if (h >= g.size()) {
/*  19 */       g.add(a(0.0D, 0.0D, 0.0D, 0.0D, 0.0D, 0.0D));
/*     */     }
/*  21 */     return ((cy)g.get(h++)).c(paramDouble1, paramDouble2, paramDouble3, paramDouble4, paramDouble5, paramDouble6);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private cy(double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4, double paramDouble5, double paramDouble6) {
...
/*     */   }
/*     */   
/*     */   public cy c(double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4, double paramDouble5, double paramDouble6) {
...
/*     */   }
/*     */   
/*     */   public cy a(double paramDouble1, double paramDouble2, double paramDouble3) {
/*  48 */     double d1 = this.a;
/*  49 */     double d2 = this.b;
/*  50 */     double d3 = this.c;
/*  51 */     double d4 = this.d;
...
/*     */   }
/*     */   
/*     */   public cy b(double paramDouble1, double paramDouble2, double paramDouble3) {
...
/*     */   }
/*     */   
/*     */   public cy c(double paramDouble1, double paramDouble2, double paramDouble3) {
...
/*     */   }
/*     */   
/*     */   public double a(cy paramcy, double paramDouble) {
...
/*     */   }
/*     */   
/*     */   public double b(cy paramcy, double paramDouble) {
...
/*     */   }
/*     */   
/*     */   public double c(cy paramcy, double paramDouble) {
...
/*     */ 
/*     */   
/*     */   public cy d(double paramDouble1, double paramDouble2, double paramDouble3) {
...
/*     */ 
/*     */   
/*     */   public cy e(double paramDouble1, double paramDouble2, double paramDouble3) {
...
/* 200 */     as as1 = paramas1.a(paramas2, this.a);
/* 201 */     as as2 = paramas1.a(paramas2, this.d);
/*     */     
/* 203 */     as as3 = paramas1.b(paramas2, this.b);
/* 204 */     as as4 = paramas1.b(paramas2, this.e);
/*     */     
/* 206 */     as as5 = paramas1.c(paramas2, this.c);
/* 207 */     as as6 = paramas1.c(paramas2, this.f);
/*     */     
