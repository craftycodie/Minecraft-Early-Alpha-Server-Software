...
/*     */   public double j;
/*     */   public double k;
/*  33 */   public final cy u = cy.a(0.0D, 0.0D, 0.0D, 0.0D, 0.0D, 0.0D); public double l; public double m; public double n; public double o; public double p; public float q; public float r; public float s; public float t;
...
/*  79 */     if (paramObject instanceof db) {
/*  80 */       return (((db)paramObject).c == this.c);
/*     */     }
/*  82 */     return false;
/*     */   }
/*     */   
...
/* 177 */         float f2 = fw.b(this.u.b); byte b;
/* 178 */         for (b = 0; b < 1.0F + this.C * 20.0F; b++) {
...
/*     */         } 
/* 183 */         for (b = 0; b < 1.0F + this.C * 20.0F; b++) {
...
/* 229 */     cy cy1 = this.u.c(paramDouble1, paramDouble2, paramDouble3);
...
/*     */     
/* 253 */     cy cy1 = this.u.b();
/* 254 */     List<cy> list = this.g.a(this, this.u.a(paramDouble1, paramDouble2, paramDouble3));
/*     */     
/*     */     byte b1;
/* 257 */     for (b1 = 0; b1 < list.size(); b1++)
/* 258 */       paramDouble2 = ((cy)list.get(b1)).b(this.u, paramDouble2); 
...
/* 269 */       paramDouble1 = ((cy)list.get(b2)).a(this.u, paramDouble1); 
...
/* 277 */       paramDouble3 = ((cy)list.get(b2)).c(this.u, paramDouble3); 
...
/* 299 */         paramDouble2 = ((cy)list.get(b)).b(this.u, paramDouble2); 
...
/* 308 */         paramDouble1 = ((cy)list.get(b)).a(this.u, paramDouble1); 
...
/* 316 */         paramDouble3 = ((cy)list.get(b)).c(this.u, paramDouble3); 
...
/* 363 */       int i6 = this.g.a(i3, i4, i5);
/* 364 */       if (this.F > this.b && i6 > 0) {
/* 365 */         this.b++;
/* 366 */         bl bl = (et.n[i6]).bj;
/* 367 */         if (this.g.a(i3, i4 + 1, i5) == et.aS.ba) {
/* 368 */           bl = et.aS.bj;
/* 369 */           this.g.a(this, bl.c(), bl.a() * 0.15F, bl.b());
/* 370 */         } else if (!(et.n[i6]).bl.d()) {
/* 371 */           this.g.a(this, bl.c(), bl.a() * 0.15F, bl.b());
/*     */         } 
/* 373 */         et.n[i6].b(this.g, i3, i4, i5, this);
/*     */       } 
/*     */     } 
/*     */ 
/*     */     
...
/* 387 */           int i5 = this.g.a(i2, i3, i4);
/* 388 */           if (i5 > 0) {
/* 389 */             et.n[i5].a(this.g, i2, i3, i4, this);
/*     */           }
/*     */         } 
/*     */       } 
/*     */     } 
...
/*     */   
/*     */   public boolean m() {
/* 427 */     return this.g.a(this.u.b(0.0D, -0.4000000059604645D, 0.0D), hz.f, this);
/*     */   }
/*     */   
...
/* 435 */     int m = this.g.a(i, j, k);
/* 436 */     if (m != 0 && (et.n[m]).bl == paramhz) {
/* 437 */       float f1 = cg.b(this.g.b(i, j, k)) - 0.11111111F;
/* 438 */       float f2 = (j + 1) - f1;
/* 439 */       return (d < f2);
/*     */     } 
/* 441 */     return false;
...
/*     */   
/*     */   public boolean o() {
/* 449 */     return this.g.a(this.u.b(0.0D, -0.4000000059604645D, 0.0D), hz.g);
/*     */   }
/*     */   
...
/*     */ 
/*     */   
/*     */   public void b(db paramdb, int paramInt) {}
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 643 */     de de1 = paramr.k("Pos");
/* 644 */     de de2 = paramr.k("Motion");
/* 645 */     de de3 = paramr.k("Rotation");
/* 646 */     a(0.0D, 0.0D, 0.0D);
/*     */     
/* 648 */     this.n = ((dk)de2.a(0)).a;
/* 649 */     this.o = ((dk)de2.a(1)).a;
/* 650 */     this.p = ((dk)de2.a(2)).a;
/*     */     
/* 652 */     this.h = this.I = this.k = ((dk)de1.a(0)).a;
/* 653 */     this.i = this.J = this.l = ((dk)de1.a(1)).a;
/* 654 */     this.j = this.K = this.m = ((dk)de1.a(2)).a;
/*     */     
/* 656 */     this.s = this.q = ((k)de3.a(0)).a;
/* 657 */     this.t = this.r = ((k)de3.a(1)).a;
/*     */     
/* 659 */     this.H = paramr.f("FallDistance");
/* 660 */     this.T = paramr.c("Fire");
/* 661 */     this.X = paramr.c("Air");
/* 662 */     this.v = paramr.l("OnGround");
/*     */     
...
/*     */ 
/*     */   
/*     */   protected de a(double... paramVarArgs) {
/* 678 */     de de = new de();
...
/*     */   }
/*     */   
/*     */   protected de a(float... paramVarArgs) {
/* 685 */     de de = new de();
...
/*     */ 
/*     */   
/*     */   public fa a(int paramInt1, int paramInt2) {
/* 696 */     return a(paramInt1, paramInt2, 0.0F);
/*     */   }
/*     */   
/*     */   public fa a(int paramInt1, int paramInt2, float paramFloat) {
/* 700 */     fa fa = new fa(this.g, this.k, this.l + paramFloat, this.m, new gc(paramInt1, paramInt2));
/* 701 */     fa.ac = 10;
/* 702 */     this.g.a(fa);
/* 703 */     return fa;
/*     */   }
...
/*     */   }
/*     */   
/*     */   protected abstract void b(r paramr);
/*     */   
