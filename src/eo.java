...
/*    */   private boolean b;
/*    */   
/*    */   protected eo(int paramInt, Class paramClass, boolean paramBoolean) {
/* 16 */     super(paramInt, hz.c);
...
/* 37 */     if (this.b)
/*    */       return; 
/* 39 */     int i = paramhb.b(paramInt1, paramInt2, paramInt3);
/*    */     
...
/*    */     
/* 82 */     if (this.b) {
/* 83 */       if (!paramdp.c(paramInt1, paramInt2 - 1, paramInt3).a()) bool = true; 
/*    */     } else {
/* 85 */       int i = paramdp.b(paramInt1, paramInt2, paramInt3);
/* 86 */       bool = true;
/* 87 */       if (i == 2 && paramdp.c(paramInt1, paramInt2, paramInt3 + 1).a()) bool = false; 
/* 88 */       if (i == 3 && paramdp.c(paramInt1, paramInt2, paramInt3 - 1).a()) bool = false; 
/* 89 */       if (i == 4 && paramdp.c(paramInt1 + 1, paramInt2, paramInt3).a()) bool = false; 
/* 90 */       if (i == 5 && paramdp.c(paramInt1 - 1, paramInt2, paramInt3).a()) bool = false; 
/*    */     } 
/* 92 */     if (bool) {
/* 93 */       a_(paramdp, paramInt1, paramInt2, paramInt3, paramdp.b(paramInt1, paramInt2, paramInt3));
/* 94 */       paramdp.d(paramInt1, paramInt2, paramInt3, 0);
/*    */     } 
/*    */     
