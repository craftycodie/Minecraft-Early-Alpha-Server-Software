...
/*    */   extends gb
/*    */ {
/*    */   protected ex(int paramInt1, int paramInt2) {
...
/* 21 */       int i = paramdp.b(paramInt1, paramInt2, paramInt3);
/* 22 */       if (i < 15) {
/* 23 */         paramdp.b(paramInt1, paramInt2, paramInt3, i + 1);
/*    */       } else {
/* 25 */         fv fv; paramdp.a(paramInt1, paramInt2, paramInt3, 0);
/* 26 */         hl hl = new hl();
/* 27 */         if (paramRandom.nextInt(10) == 0) {
/* 28 */           fv = new fv();
/*    */         }
/* 30 */         if (!fv.a(paramdp, paramRandom, paramInt1, paramInt2, paramInt3))
/* 31 */           paramdp.a(paramInt1, paramInt2, paramInt3, this.ba); 
/*    */       } 
/*    */     } 
/*    */   }
/*    */ }
