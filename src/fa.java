...
/*     */   
/*     */   public fa(dp paramdp, double paramDouble1, double paramDouble2, double paramDouble3, gc paramgc) {
/*  27 */     super(paramdp);
/*  28 */     a(0.25F, 0.25F);
...
/*  55 */     if (this.g.c(fw.b(this.k), fw.b(this.l), fw.b(this.m)) == hz.g) {
...
/*  67 */     if (this.v) {
/*  68 */       f = 0.58800006F;
/*  69 */       int i = this.g.a(fw.b(this.k), fw.b(this.u.b) - 1, fw.b(this.m));
/*  70 */       if (i > 0) {
/*  71 */         f = (et.n[i]).bm * 0.98F;
/*     */       }
/*     */     } 
/*     */     
/*  75 */     this.n *= f;
...
/*     */   
/*     */   public boolean m() {
/* 110 */     return this.g.a(this.u, hz.f, this);
/*     */   }
/*     */   
...
/*     */     
/* 122 */     if (et.p[this.g.a(i, j, k)]) {
/* 123 */       boolean bool1 = !et.p[this.g.a(i - 1, j, k)] ? true : false;
/* 124 */       boolean bool2 = !et.p[this.g.a(i + 1, j, k)] ? true : false;
/* 125 */       boolean bool3 = !et.p[this.g.a(i, j - 1, k)] ? true : false;
/* 126 */       boolean bool4 = !et.p[this.g.a(i, j + 1, k)] ? true : false;
/* 127 */       boolean bool5 = !et.p[this.g.a(i, j, k - 1)] ? true : false;
/* 128 */       boolean bool6 = !et.p[this.g.a(i, j, k + 1)] ? true : false;
/*     */       
/* 130 */       byte b = -1;
...
/* 184 */     paramr.a("Item", this.a.a(new r()));
/*     */   }
/*     */   
/*     */   public void b(r paramr) {
/* 188 */     this.af = paramr.c("Health") & 0xFF;
/* 189 */     this.b = paramr.c("Age");
/* 190 */     r r1 = paramr.j("Item");
/* 191 */     this.a = new gc(r1);
/*     */   }
/*     */   
