...
/*     */   extends et
/*     */ {
/*     */   protected fp(int paramInt1, int paramInt2) {
/*  11 */     super(paramInt1, paramInt2, hz.n);
/*  12 */     a(true);
/*     */   }
/*     */   
...
/*  51 */     int i = paramdp.b(paramInt1, paramInt2, paramInt3);
/*     */     
...
/*  64 */     if (paramdp.b(paramInt1, paramInt2, paramInt3) == 0) e(paramdp, paramInt1, paramInt2, paramInt3); 
/*     */   }
/*     */   
...
/*  84 */       int i = paramdp.b(paramInt1, paramInt2, paramInt3);
...
/*     */       
/*  93 */       if (bool) {
/*  94 */         a_(paramdp, paramInt1, paramInt2, paramInt3, paramdp.b(paramInt1, paramInt2, paramInt3));
/*  95 */         paramdp.d(paramInt1, paramInt2, paramInt3, 0);
/*     */       } 
/*     */     } 
/*     */   }
/*     */   
...
/* 102 */       a_(paramdp, paramInt1, paramInt2, paramInt3, paramdp.b(paramInt1, paramInt2, paramInt3));
/* 103 */       paramdp.d(paramInt1, paramInt2, paramInt3, 0);
/* 104 */       return false;
/*     */     } 
/* 106 */     return true;
/*     */   }
...
/* 110 */     int i = paramdp.b(paramInt1, paramInt2, paramInt3) & 0x7;
/*     */     
/* 112 */     float f = 0.15F;
/* 113 */     if (i == 1) {
