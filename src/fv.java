...
/* 141 */     byte b1 = a[paramByte];
/* 142 */     byte b2 = a[paramByte + 3];
...
/* 159 */         int m = this.c.a(arrayOfInt2[0], arrayOfInt2[1], arrayOfInt2[2]);
/* 160 */         if (m != 0 && m != 18) {
/*     */ 
/*     */           
/* 163 */           k++;
/*     */           continue;
/*     */         } 
/* 166 */         this.c.a(arrayOfInt2[0], arrayOfInt2[1], arrayOfInt2[2], paramInt4);
/* 167 */         k++;
/*     */       } 
/* 169 */       j++;
/*     */     } 
...
/* 258 */       this.c.a(arrayOfInt2[0], arrayOfInt2[1], arrayOfInt2[2], paramInt);
/* 259 */       i += b5;
/*     */     } 
/*     */   }
/*     */ 
...
/* 374 */       int k = this.c.a(arrayOfInt2[0], arrayOfInt2[1], arrayOfInt2[2]);
/* 375 */       if (k != 0 && k != 18) {
/*     */         break;
/*     */       }
/*     */ 
...
/*     */     
/* 404 */     int i = this.c.a(this.d[0], this.d[1] - 1, this.d[2]);
/* 405 */     if (i != 2 && i != 3) {
/* 406 */       return false;
/*     */     }
