...
/*    */   }
/*    */   
/*    */   public gs(int paramInt1, int paramInt2, short[] paramArrayOfshort, int paramInt3, dp paramdp) {
/* 20 */     this.j = true;
/* 21 */     this.a = paramInt1;
/* 22 */     this.b = paramInt2;
/* 23 */     this.f = paramInt3;
...
/* 27 */     hv hv = paramdp.b(paramInt1, paramInt2);
/* 28 */     for (byte b = 0; b < paramInt3; b++) {
...
/* 34 */       this.d[b] = (byte)hv.a(i, k, j);
/* 35 */       this.e[b] = (byte)hv.b(i, k, j);
/*    */     } 
/*    */   }
/*    */   
