...
/* 572 */   public Chunk b(int paramInt1, int paramInt2) { this.j.setSeed(paramInt1 * 341873128712L + paramInt2 * 132897987541L); byte[] arrayOfByte = new byte[32768]; Chunk hv = new Chunk(this.p, arrayOfByte, paramInt1, paramInt2); a(paramInt1, paramInt2, arrayOfByte); b(paramInt1, paramInt2, arrayOfByte); c(paramInt1, paramInt2, arrayOfByte); hv.b(); return hv; } protected void a(int paramInt1, int paramInt2, byte[] paramArrayOfbyte, double paramDouble1, double paramDouble2, double paramDouble3) { a(paramInt1, paramInt2, paramArrayOfbyte, paramDouble1, paramDouble2, paramDouble3, 1.0F + this.j.nextFloat() * 6.0F, 0.0F, 0.0F, -1, -1, 0.5D); } public void a(IChunkProvider parambf, int paramInt1, int paramInt2) { WorldGenBigTree fv = null; BlockSand.a = true;
...
/* 605 */       (new dv(Block.v.blockId, 32)).a(this.p, this.j, n, i1, i2);
/*     */     } 
/*     */     
/* 608 */     for (k = 0; k < 10; k++) {
...
/* 612 */       (new dv(Block.F.blockId, 32)).a(this.p, this.j, n, i1, i2);
/*     */     } 
/*     */     
/* 615 */     for (k = 0; k < 20; k++) {
...
/* 619 */       (new dv(Block.I.blockId, 16)).a(this.p, this.j, n, i1, i2);
/*     */     } 
/*     */     
/* 622 */     for (k = 0; k < 20; k++) {
...
/* 626 */       (new dv(Block.H.blockId, 8)).a(this.p, this.j, n, i1, i2);
/*     */     } 
/*     */     
/* 629 */     for (k = 0; k < 2; k++) {
...
/* 633 */       (new dv(Block.G.blockId, 8)).a(this.p, this.j, n, i1, i2);
/*     */     } 
/*     */     
/* 636 */     for (k = 0; k < 8; k++) {
...
/* 640 */       (new dv(Block.aN.blockId, 7)).a(this.p, this.j, n, i1, i2);
/*     */     } 
/*     */     
/* 643 */     for (k = 0; k < 1; k++) {
...
/* 647 */       (new dv(Block.aw.blockId, 7)).a(this.p, this.j, n, i1, i2);
/*     */     } 
/*     */     
/* 650 */     d = 0.5D;
...
/* 713 */       (new hc(Block.A.blockId)).a(this.p, this.j, n, i1, i2);
/*     */     } 
/*     */     
/* 716 */     for (m = 0; m < 20; m++) {
...
/* 720 */       (new hc(Block.C.blockId)).a(this.p, this.j, n, i1, i2);
/*     */     } 
/*     */     
/* 723 */     if (this.p.c) {
