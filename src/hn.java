...
/*     */   extends et
/*     */ {
/*     */   protected hn(int paramInt, hz paramhz) {
/*  14 */     super(paramInt, paramhz);
/*  15 */     this.aZ = 97;
/*  16 */     if (paramhz == hz.e) this.aZ++;
/*     */     
/*  18 */     float f1 = 0.5F;
/*  19 */     float f2 = 1.0F;
...
/*  70 */     b(d(paramhb.b(paramInt1, paramInt2, paramInt3)));
/*     */   }
/*     */   
...
/*  87 */     if (this.bl == hz.e) return true;
/*     */     
/*  89 */     int i = paramdp.b(paramInt1, paramInt2, paramInt3);
/*  90 */     if ((i & 0x8) != 0) {
/*  91 */       if (paramdp.a(paramInt1, paramInt2 - 1, paramInt3) == this.ba) {
/*  92 */         a(paramdp, paramInt1, paramInt2 - 1, paramInt3, parameq);
/*     */       }
/*  94 */       return true;
/*     */     } 
/*  96 */     if (paramdp.a(paramInt1, paramInt2 + 1, paramInt3) == this.ba) {
...
/*     */   }
/*     */   
/*     */   public void a(dp paramdp, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean) {
/* 112 */     int i = paramdp.b(paramInt1, paramInt2, paramInt3);
/*     */     
/* 114 */     if ((i & 0x8) != 0) {
/* 115 */       if (paramdp.a(paramInt1, paramInt2 - 1, paramInt3) == this.ba) {
/* 116 */         a(paramdp, paramInt1, paramInt2 - 1, paramInt3, paramBoolean);
/*     */       }
/*     */       
/*     */       return;
/*     */     } 
/* 121 */     boolean bool = ((paramdp.b(paramInt1, paramInt2, paramInt3) & 0x4) > 0);
/* 122 */     if (bool == paramBoolean)
/*     */       return; 
/* 124 */     if (paramdp.a(paramInt1, paramInt2 + 1, paramInt3) == this.ba) {
...
/* 140 */     int i = paramdp.b(paramInt1, paramInt2, paramInt3);
/* 141 */     if ((i & 0x8) != 0) {
/* 142 */       if (paramdp.a(paramInt1, paramInt2 - 1, paramInt3) != this.ba) {
/* 143 */         paramdp.d(paramInt1, paramInt2, paramInt3, 0);
/*     */       }
/* 145 */       if (paramInt4 > 0 && et.n[paramInt4].d()) {
/* 146 */         b(paramdp, paramInt1, paramInt2 - 1, paramInt3, paramInt4);
/*     */       }
/*     */     } else {
/* 149 */       boolean bool = false;
/* 150 */       if (paramdp.a(paramInt1, paramInt2 + 1, paramInt3) != this.ba) {
/* 151 */         paramdp.d(paramInt1, paramInt2, paramInt3, 0);
/* 152 */         bool = true;
/*     */       } 
/* 154 */       if (!paramdp.d(paramInt1, paramInt2 - 1, paramInt3)) {
/* 155 */         paramdp.d(paramInt1, paramInt2, paramInt3, 0);
/* 156 */         bool = true;
/* 157 */         if (paramdp.a(paramInt1, paramInt2 + 1, paramInt3) == this.ba) {
/* 158 */           paramdp.d(paramInt1, paramInt2 + 1, paramInt3, 0);
/*     */         }
/*     */       } 
/* 161 */       if (bool) {
/* 162 */         a_(paramdp, paramInt1, paramInt2, paramInt3, i);
/*     */       }
/* 164 */       else if (paramInt4 > 0 && et.n[paramInt4].d()) {
...
/* 174 */     if (this.bl == hz.e) return en.az.aQ; 
/* 175 */     return en.at.aQ;
/*     */   }
/*     */   
